        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="relative p-8 bg-white/[0.02] rounded-2xl border border-white/5 backdrop-blur-xs text-center">
                <div className="flex items-center justify-center w-12 h-12 mx-auto mb-6 rounded-2xl bg-linear-to-r from-purple-500/10 to-purple-500/10">
                  <stat.icon className="h-3 lg:h-6 w-3 lg:w-6 text-purple-400" />
                </div>
                <div className="text-2xl lg:text-4xl font-bold mb-2 bg-linear-to-r from-white to-purple-200 bg-clip-text text-transparent">
                  {stat.value}
                </div>
