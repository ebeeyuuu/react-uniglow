...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 bg-linear-to-b from-purple-500/15 via-transparent to-transparent z-10" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-20">
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <h1 data-aos="fade-up" data-aos-delay="350" className="text-4xl lg:text-6xl font-bold mb-6 bg-linear-to-r from-white via-white to-purple-200 bg-clip-text text-transparent text-center">
            Meet the Team
          </h1>
