    ...
    <section className="py-24 relative flex justify-center items-center">
      ...
      <div className="max-w-4xl mx-auto px-4 relative flex flex-col md:flex-row items-center justify-center space-y-12 md:space-y-0 md:space-x-12">
        ...
        <div className="relative w-full md:w-1/2">
          <div className="absolute inset-0 bg-linear-to-r from-purple-500/10 to-transparent opacity-50 rounded-xl" />
          <div className="relative px-14 py-20 bg-white/[0.02] rounded-xl border border-white/10 backdrop-blur-xs">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-xl focus:outline-hidden focus:border-purple-500"
                />
              </div>
              <div>
                <label className="block text-xs lg:text-sm font-medium text-white/60 mb-2">
                ...
                <input
                  type="email"
                  className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-lg focus:outline-hidden focus:border-purple-500"
                />
              </div>
              <div>
                <label className="block text-xs lg:text-sm font-medium text-white/60 mb-2">
                ...
                <textarea className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-lg focus:outline-hidden focus:border-purple-500 h-20"></textarea>
              </div>
