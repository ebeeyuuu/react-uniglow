            ...
            <div key={index} className="group relative">
              ...
              <div className="relative p-6 bg-white/[0.02] rounded-xl border border-white/10 backdrop-blur-sm">
                <div className="flex items-center mb-4">
                  ...
                  />
                  <div className="ml-4">
                    <div className="text-sm lg:text-base font-semibold">{testimonial.name}</div>
                    <div className="text-xs lg:text-sm text-white/60">{testimonial.role}</div>
                    <div className="text-xs lg:text-sm text-purple-400">{testimonial.company}</div>
                  </div>
                </div>
                ...
                <p className="text-xs lg:text-base text-white/60">{testimonial.content}</p>
              </div>
            </div>
          ))}
        </div>
