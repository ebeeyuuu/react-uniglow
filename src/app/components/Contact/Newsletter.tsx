    ...
    <div className="mt-[40px]">
      <div className="flex flex-col gap-y-[20px] max-[900px]:justify-center max-[900px]:ml-[40px]">
        ...
        <div className="flex flex-col gap-y-[15px]">
          ...
          />
          {error && <div className="text-[#ff7f00] text-sm mt-1 font-bold">{error}</div>}
          <div className="px-3 py-2 border-white border w-[100px] flex items-center justify-center mt-[10px] rounded-[10px] cursor-pointer">
            Sign up
          </div>
        </div>
      </div>
