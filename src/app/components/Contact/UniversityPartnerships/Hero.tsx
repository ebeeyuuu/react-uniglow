  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center px-4">
        <h1 className="text-2xl lg:text-4xl md:text-6xl font-bold pb-4 bg-linear-to-r from-white to-purple-200 bg-clip-text text-transparent">
        ...
        <button className="bg-linear-to-r from-black via-black to-purple-950 text-white px-8 py-3 rounded-xl text-sm lg:text-base font-semibold hover:bg-purple-700 transition duration-300">
          Become a Partner
        </button>
      </div>
    </section>
