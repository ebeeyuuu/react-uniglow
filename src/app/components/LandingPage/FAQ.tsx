...
const faqItems: FAQItem[] = [
  {
    ...
    answer: "Our AI analyses your personality traits, academic interests, and preferences to match you with universities that best suit your profile."
  },
  {
    question: "Are the VR campus tours available for all universities?",
    answer: "We currently offer VR tours for our partner universities and are continually expanding our selection."
  },
  {
    question: "How do I connect with a peer mentor?",
    answer: "After creating your profile, you can request a mentor match based on your interests and university preferences."
  },
  {
    question: "Is the Interactive Curriculum Explorer accurate for all listed universities?",
    answer: "We regularly update our curriculum data, but always advise verifying with the university's official sources."
  },
  {
    question: "Is Uniglow's service free?",
    answer: "Basic features are free, whilst advanced tools like personalised counselling are available through our premium plan."
  }
];
...
const FAQ: React.FC = () => {
  return (
    <div className="mt-[500px] w-full flex flex-col items-center gap-y-[20px]">
      ...
      <p className="text-base font-light w-full max-w-[500px] text-center">
      ...
      <button className="bg-[#ca6200] px-5 py-2 rounded-[10px] font-medium mt-[20px]">
        See all FAQs
      </button>
