...
const Features: React.FC = () => {
  ...
  const getBoxContent = useCallback((boxId: string, icon: React.ReactElement, text: string) => (
  ...
  return (
    <div className="w-full mt-[500px] flex justify-center items-center flex-row gap-x-[70px] max-[900px]:flex-col-reverse max-[900px]:gap-y-[70px]">
      ...
      <div className="flex flex-col gap-y-[30px] w-1/3 max-[900px]:text-center max-[900px]:w-[80%] max-[900px]:mx-auto">
        <div className="text-5xl font-semibold">
          What separates <span className="text-[#e17100] italic underline decoration-[3px] underline-offset-[3px] font-bold">us</span> from <span className="text-[#813e00] font-semibold">the rest</span>
        </div>
        <div>
