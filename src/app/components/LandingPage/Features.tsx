...
const features = [
  {
    ...
    description:
      "Our advanced AI analyzes your interests and goals to find your perfect university matches",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Get instant answers to your questions with our AI-powered chat assistant and expert counselors",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Stay on top of your applications with our intelligent tracking and reminder system",
    benefits: [
      "Deadline management",
      "Document checklist",
  ...
  },
  {
    ...
    description:
      "Apply to multiple universities with a single application form and automated document submission",
    benefits: [
    ...
    <section className="py-24 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 relative">
        <div className="text-center mb-16">
          ...
          >
            Cutting-edge technology meets expert guidance to transform your
          ...
          {features.map((feature, index) => (
            <div key={index} className="group relative">
              ...
              <div className="relative p-8 bg-white/[0.02] rounded-2xl border-2 border-white/5 backdrop-blur-sm">
                ...
                <p className="text-xs lg:text-base text-white/60 mb-6">
                  {feature.description}
                </p>
