  ...
  return (
    <div className="w-full flex justify-center items-center flex-col mt-[100px]">
      <div className="flex flex-row justify-center items-center max-[900px]:flex-col mx-auto">
        <div className="w-[90%] h-[100vh] max-[700px]:h-[115vh] grid grid-rows-12 grid-cols-11 gap-[20px] mt-[100px] text-black max-[900px]:gap-[15px] max-[700px]:grid-rows-11 max-[700px]:grid-cols-3">
          <motion.div
          ...
          <div className="row-span-3 col-span-5 max-[700px]:row-span-3 max-[700px]:col-span-3 text-white flex justify-center items-center">
            <div className="flex flex-row items-center text-center gap-y-[15px] w-[80%] mx-auto max-[1000px]:flex-col max-[900px]:text-center">
              <div className="mb-4 max-[1200px]:text-4xl max-[2000px]:text-5xl max-[4000px]:text-6xl font-bold max-[900px]:text-2xl text-left w-1/3 max-[1000px]:text-center max-[1000px]:w-full">
                Find Your Dream University
              </div>
              <div className="flex flex-col w-5/12 ml-auto max-[1000px]:w-full">
                <div className="mb-2 text-right max-[900px]:text-sm max-[1000px]:text-center max-[1200px]:text-base max-[2000px]:text-lg max-[4000px]:text-xl">
