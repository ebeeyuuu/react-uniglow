...
const teacherParentTestimonials: Testimonial[] = [
  {
    ...
    image: image7,
    rating: 5,
    review: "Uniglow has revolutionized how I advise students. It provides comprehensive, tailored university suggestions that I can trust."
  },
  {
    name: "Mrs. Thompson",
    ...
    image: image7,
    rating: 4.5,
    review: "As a parent, I found Uniglow incredibly helpful in guiding my child through the college selection process. It eased a lot of our stress!"
  },
  {
    name: "Prof. Martinez",
    ...
    image: image7,
    rating: 5,
    review: "Uniglow helps students find universities that truly fit their needs and aspirations. It's a valuable tool for both students and institutions."
  },
  {
    name: "Ms. Chen",
    role: "Career Advisor",
    image: image7,
    rating: 5,
    review: "I recommend Uniglow to all my students. It aligns their career goals with suitable university programs, setting them up for future success."
  },
  {
    name: "Mr. Patel",
    ...
    image: image7,
    rating: 4.5,
    review: "Uniglow has made the daunting task of college search manageable for our family. It's user-friendly and provides excellent insights."
  },
  {
    name: "Dr. Williams",
    ...
    image: image7,
    rating: 5,
    review: "Uniglow is a game-changer in college advising. It offers data-driven recommendations that consistently impress both students and parents."
  },
  {
    name: "Mrs. Garcia",
    ...
    image: image7,
    rating: 4.5,
    review: "We've implemented Uniglow in our school's college counseling program, and the results have been outstanding. It's an invaluable resource."
  },
  {
    name: "Mr. Nguyen",
    ...
    image: image7,
    rating: 5,
    review: "Uniglow made it easy to help both our children find universities that fit their different interests and goals. It's incredibly versatile!"
  },
  {
    name: "Ms. Anderson",
    ...
    image: image7,
    rating: 4.5,
    review: "Uniglow's insights help students focus their essays on what makes them unique. It's a great complement to the writing process."
  },
  {
    name: "Dr. Lee",
    ...
    image: image7,
    rating: 5,
    review: "For students interested in STEM fields, Uniglow does an excellent job matching them with universities that have strong programs in their areas of interest."
  }
];
  ...
  <div className="flex flex-col space-y-4 mx-4 border border-white rounded-[10px] p-6 w-[300px]">
    <div className="flex items-start space-x-4">
      ...
      <div className="flex flex-col">
        ...
        <p className="text-base text-gray-300">{testimonial.role}</p>
      </div>
    </div>
