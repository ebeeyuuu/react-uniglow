  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center max-[1000px]:ml-0 px-[15px] overflow-hidden max-[700px]:px-[10px] max-[700px]:py-[15px] relative">
      <button
        ...
        className="absolute left-[50px] z-50 top-1/2 transform -translate-y-1/2 text-white flex items-center disabled:opacity-70 disabled:cursor-not-allowed max-[1000px]:-translate-y-0 max-[1000px]:left-1/2 max-[1000px]:ml-[-80px] max-[1000px]:bottom-0 max-[1000px]:mt-[35vh] px-5 py-3 rounded-full bg-black/80"
      >
      ...
      <button
        ...
        className="absolute right-[50px] z-50 top-1/2 transform -translate-y-1/2 text-white flex items-center disabled:opacity-70 disabled:cursor-not-allowed max-[1000px]:-translate-y-0 max-[1000px]:right-1/2 max-[1000px]:mr-[-80px] max-[1000px]:bottom-0 max-[1000px]:mt-[calc(35vh+2px)] px-5 py-3 rounded-full bg-black/80"
      >
        <span>Next</span>
