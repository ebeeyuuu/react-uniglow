...
const AIMatcherSection: React.FC<AIMatcherSectionProps> = ({ index }) => {
  ...
  return (
    <div
      className={`relative row-span-1 col-span-2 max-[2000px]:col-span-4 max-[2000px]:-order-9 rounded-[10px] flex justify-center items-center font-bold text-center cursor-pointer smooth-animation overflow-hidden bg-black`}
    ...
    >
      <div className="relative flex items-center justify-center w-full h-full">
        ...
        <motion.div
          className={`absolute flex items-center justify-center max-sm:text-base max-md:text-lg text-xl smooth-animation ${
