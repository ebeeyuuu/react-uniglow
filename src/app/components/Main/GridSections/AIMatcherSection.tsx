...
const AIMatcherSection = () => {
  ...
  return (
    <div
      className={`relative row-span-1 col-span-2 max-[2000px]:col-span-4 max-[2000px]:-order-8 rounded-[10px] flex justify-center items-center font-bold text-center cursor-pointer smooth-animation overflow-hidden bg-gradient-to-b from-[#212121] to-[#111111]`}
