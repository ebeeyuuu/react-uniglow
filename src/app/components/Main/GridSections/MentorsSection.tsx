    ...
    >
      <div className="relative p-5 max-[700px]:text-base max-[1000px]:text-lg max-[1300px]:text-2xl text-3xl transition-all duration-200 ease-in-out">
        ...
        >
          ...
          />
          <p className="max-sm:text-xs mad-md:text-sm text-base max-[1000px]:w-[90%] max-[2000px]:w-[75%] max-[3000px]:w-[65%] max-[4000px]:w-[55%] mx-auto font-light w-full">
            Get advice with our:
          </p>
        </motion.div>
      </div>
      <motion.div
        className="absolute max-sm:text-base max-md:text-lg text-xl z-50 flex items-center justify-center"
